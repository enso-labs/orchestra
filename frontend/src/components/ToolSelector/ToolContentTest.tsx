				...
				return (
					<div key={key} className="mb-3">
						...
						<Input
							id={key}
							value={
								typeof testFormValues[key] === "object"
		...
		<div className="p-6">
			...
			<form onSubmit={handleTestFormSubmit}>
				<div className="space-y-2 mb-4">
					{testingTool.args &&
						Object.entries(testingTool.args).map(
							([key, argDef]: [string, any]) => renderFormField(key, argDef),
						)}
				</div>

				<DialogFooter className="mt-6">
					<Button type="button" variant="outline" onClick={cancelTesting}>
						Cancel
					</Button>
					<Button type="submit">
