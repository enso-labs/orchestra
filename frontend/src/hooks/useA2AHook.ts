...
export default function useA2AHook() {
	...
	const [isLoadingA2AInfo, setIsLoadingA2AInfo] = useState(
		INIT_A2A_STATE.isLoadingA2AInfo,
	);
	const [a2aInfoError, setA2aInfoError] = useState<string | null>(
		INIT_A2A_STATE.a2aInfoError,
	);
