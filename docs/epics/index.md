...
![Epics grid view with search and epic cards](../img/epics/01-epics-grid.png)
...
![Create Epic dialog with name and description fields](../img/epics/02-create-epic.png)
...
![Epic detail view with task list and status indicators](../img/epics/03-epic-detail.png)
...
![Task status dropdown showing To Do, In Progress, Done, and Blocked options](../img/epics/04-task-status.png)
