...
def upgrade() -> None:
    ...
    op.execute('ALTER TABLE threads RENAME CONSTRAINT user_threads_pkey TO threads_pkey')
...
def downgrade() -> None:
    ...
    op.execute('ALTER TABLE threads RENAME CONSTRAINT threads_pkey TO user_threads_pkey')
