...
class FakeStreamWriter:
	def __init__(self): self.buffer: list[str] = []
	def write(self, chunk: str) -> None: self.buffer.append(chunk)
...
class TestToolRuntime:
	...
	config: RunnableConfig = field(default_factory=lambda: RunnableConfig(
