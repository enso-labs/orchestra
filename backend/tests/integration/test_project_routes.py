    ...
    sources_data = [
        {
            "type": "base64",
            "content": {
                "data": ["data:text/plain;base64,VGVzdCBkYXRh"]
            }
        }
    ]
    ...
    sources_data = [
        {
            "type": "base64",
            "content": {
                "data": ["data:text/plain;base64,RGVsZXRlIHRlc3Q="]
            }
        }
    ]
    ...
    sources_data = [
        {
            "type": "base64",
            "content": {
                "data": ["data:text/plain;base64,U2VhcmNoYWJsZSBjb250ZW50"]
            }
        }
    ]
    ...
    sources_data = [
        {
            "type": "base64",
            "content": {
                "data": ["data:text/plain;base64,TGlmZWN5Y2xlIHRlc3Q="]
            }
        }
    ]
