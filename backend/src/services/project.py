...
class ProjectService:
    ...
    async def get_sources(self, project_id: str) -> list[Source]:
        return await self.project_repo.source_repo.list(project_id)
    
    async def delete_sources(self, project_id: str, source_ids: list[str]) -> bool:
        return await self.project_repo.source_repo.delete(project_id, source_ids)