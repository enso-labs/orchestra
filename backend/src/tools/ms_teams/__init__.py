...
async def webhook_teams(text: str, runtime: ToolRuntime) -> str:
    ...
    IMPORTANT: Standard Markdown headers like #, ##, etc., are not supported in Microsoft
    Teams messages sent via webhook and will not render as headers. Avoid using Markdown header syntax.
    Formatting:
    ...
    if not MS_TEAMS_WEBHOOK_URL:
        raise ValueError("Variable MICROSOFT_TEAMS_WEBHOOK_URL is required to send message to Microsoft Teams channel.")
