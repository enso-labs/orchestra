...
@router.post("/threads/search", name="Query Threads in Checkpointer", operation_id="ruska_search_threads")
@cache(expire=15)
...
@router.post("/threads/search/semantic", name="Semantic Search Over Threads", operation_id="ruska_semantic_search_threads")
...
@router.post("/threads", name="Create Thread", operation_id="ruska_create_thread")
...
@router.get("/threads/{thread_id}", name="Get Thread", operation_id="ruska_get_thread")
...
@router.patch("/threads/{thread_id}", name="Update Thread", operation_id="ruska_update_thread")
...
@router.delete("/threads/{thread_id}", name="Delete Thread", operation_id="ruska_delete_thread")
...
@router.delete("/a/{assistant_id}/threads/{thread_id}", name="Delete Assistant Thread", operation_id="ruska_delete_assistant_thread")
async def delete_thread(
    assistant_id: str,
    thread_id: str,
    user: ProtectedUser = Depends(verify_credentials),
